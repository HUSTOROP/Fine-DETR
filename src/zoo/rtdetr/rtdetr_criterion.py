...
from .box_ops import box_cxcywh_to_xyxy, box_iou, generalized_box_iou, bbox_iou
...
class RTDETRCriterion(nn.Module):
    ...
    def loss_boxes(self, outputs, targets, indices, num_boxes):
        ...
        # TODO
        loss_giou = 1 - torch.diag(bbox_iou(\
            box_cxcywh_to_xyxy(src_boxes), box_cxcywh_to_xyxy(target_boxes), EIoU=True))
