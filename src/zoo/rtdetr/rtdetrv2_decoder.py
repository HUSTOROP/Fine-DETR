...
class RTDETRTransformerv2(nn.Module):
    ...
    def __init__(self,
        ...
        if query_select_method == 'agnostic':
            ...
            self.enc_score_head = CosSim1d(hidden_dim, num_classes)
        ...
        # TODO
        self.dec_score_head = nn.ModuleList([
            CosSim1d(hidden_dim, num_classes) for _ in range(num_layers)
        ])
    ...
    def _get_decoder_input(self,
        ...
        return content, enc_topk_bbox_unact, enc_topk_bboxes_list, enc_topk_logits_list, enc_topk_memory
    ...
    def _select_topk(self, memory: torch.Tensor, outputs_logits: torch.Tensor, outputs_coords_unact: torch.Tensor, topk: int):
        ...
        # print(topk_memory.shape) #[4, 300, 256]
    ...
    def forward(self, feats, targets=None):
        ...
        init_ref_contents, init_ref_points_unact, enc_topk_bboxes_list, enc_topk_logits_list, enc_topk_memory = \
        ...
        # print(out_bboxes.shape) # [3, 4, 500, 4]
        # print(output_feature.shape) # [4, 500, 256]
